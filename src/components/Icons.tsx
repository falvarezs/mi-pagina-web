// Componentes de iconos profesionales en SVG
...
export const HeartIcon = ({ className = "", size = 24, filled = false }: IconProps & { filled?: boolean }) => (
  <svg 
    className={className} 
    width={size} 
    height={size} 
...
export const InfinityIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg 
    ...
    strokeLinejoin="round"
  >
    <path d="M18.178 8C19.72 8.667 21 10.2 21 12s-1.28 3.333-2.822 4c-2.264.978-4.186-.591-6.178-3-1.992 2.409-3.914 3.978-6.178 3C4.28 15.333 3 13.8 3 12s1.28-3.333 2.822-4c2.264-.978 4.186.591 6.178 3 1.992-2.409 3.914-3.978 6.178-3z"></path>
  </svg>
);
