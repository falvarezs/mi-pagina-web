            ...
            <div className="order-2 lg:order-1">
              ...
              <div className="mb-6 sm:mb-8">
                ...
                >
                  ...
                  Instituto Venezolano Gastronómico (2018), con experiencia en hoteles como
                  Pestana Caracas, Altamira Village y Waldorf. He formado a más de 1,000
                  estudiantes con paciencia, bases sólidas y práctica guiada.
                </p>
              </div>
              ...
              <div className="relative w-64 sm:w-80 md:w-96 lg:w-full max-w-md mx-auto aspect-square">
                ...
                <div className="absolute top-[8%] -right-2 sm:right-2 lg:right-4 bg-white rounded-xl sm:rounded-2xl shadow-xl p-2 sm:p-3 lg:p-4 transform rotate-3 hover:rotate-0 transition-transform animate-float z-20">
                  <div className="flex items-center space-x-1 sm:space-x-2">
                    ...
                    <div>
                      <p className="text-[10px] sm:text-xs lg:text-sm font-semibold text-gray-900 leading-tight" style={{ fontFamily: "'Montserrat', sans-serif" }}>Chef Certificada</p>
                      <p className="text-[8px] sm:text-[10px] lg:text-xs text-gray-500 uppercase" style={{ fontFamily: "'Montserrat', sans-serif" }}>IVG 2018</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute bottom-[10%] -left-2 sm:left-2 lg:left-4 bg-white rounded-xl sm:rounded-2xl shadow-xl p-2 sm:p-3 lg:p-4 transform -rotate-3 hover:rotate-0 transition-transform animate-float-delayed z-20">
                  <div className="flex items-center space-x-1 sm:space-x-2 lg:space-x-3">
                    ...
                    <div>
                      <p className="text-xs sm:text-base lg:text-2xl font-bold text-gray-900 leading-tight" style={{ fontFamily: "'Playfair Display', serif" }}>1,000+</p>
                      <p className="text-[8px] sm:text-[10px] lg:text-xs text-gray-500 uppercase tracking-wide" style={{ fontFamily: "'Montserrat', sans-serif" }}>Estudiantes</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="absolute -top-2 sm:-top-3 lg:-top-4 left-1/2 -translate-x-1/2 bg-white rounded-full shadow-xl p-2 sm:p-3 lg:p-4 hover:scale-110 transition-transform animate-float z-20">
